        ...
        return (
            <div className='row'>
                <div className="col-md-6">
                    <h3 className="text-center text_info">Experience</h3>
                    {expItems.length>0?(<ul>{expItems}</ul>): (<p className='text-center'>No Experience Listed</p>)}
                </div>
                <div className="col-md-6">
                    <h3 className="text-center text_info">Education</h3>
                    {eduItems.length>0?(<ul>{eduItems}</ul>): (<p className='text-center'>No Education Listed</p>)}
                </div>
            </div>
        )
    }
